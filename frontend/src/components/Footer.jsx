        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-x-16 gap-y-16 text-sm">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              ...
              <a href="https://linkedin.com/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full border border-[#222] flex items-center justify-center hover:border-orange-500 transition group" aria-label="LinkedIn">

          ...
          <div className="hidden md:flex items-center gap-12">
            {navItems.map((item) =>
              item.label === "Service" ? (
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                          {services.map((s) => (
                            <span
                              ...
                              `}
                            >
                              <div className="h-24 mb-6 rounded-xl overflow-hidden border border-slate-300">
                ...
                <span key={item.label} onClick={() => navigateTo(item.link)} className="text-lg font-semibold text-slate-900 inline-flex items-center gap-2 cursor-pointer">
                  {item.label}
                ...
                {navItems.map((item) =>
                  item.label === "Service" ? (
                    ...
                    <span
                      ...
                      className="block py-3 px-4 rounded-lg hover:bg-slate-50 font-semibold flex items-center justify-between cursor-pointer"
                    >

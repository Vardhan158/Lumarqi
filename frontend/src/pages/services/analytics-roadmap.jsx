...
import surfImage from "../../assets/img_Strategy-Advisory_analytics-roadmap_advancing-business_1-min-2.webp";
import surfDetail from "../../assets/img_Strategy-Advisory_analytics-roadmap_advancing-business_2-min-2.webp";
...
function HeroLottie() {
  ...
  useEffect(() => {
    const anim = lottie.loadAnimation({
      ...
      loop: true,
      autoplay: true,
      path: "/lottie/analytics-roadmap.json",
    });
...
const cardData = [
    {
      ...
      description: "We enable building a vision of possibilities aligned closely with your business strategy. We work with specific functions – customer, sales, marketing...",
    },
    {
      title: "Design thinking",
      description: "We adopt a design thinking-led approach to seek and structure inputs from multiple stakeholders. This inclusive approach serves the needs of internal...",
    },
    {
      title: "Financial case",
      description: "As part of the roadmap development, we have a structured approach to value-complexity estimation and quantifying change management. Our business...",
    }
  ];
      ...
      <main className="bg-[#f1f5ff] min-h-screen px-6 md:px-16 lg:px-24 xl:px-32 pt-28 pb-28">
        ...
        <div className="mb-16">
          <div className="flex flex-wrap gap-2 text-sm text-slate-600">
            ...
            <span>/</span>
            <span className="font-semibold text-slate-900">Analytics Roadmap</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-xl">
            ...
            <p className="text-lg text-slate-700">
              See how Tiger Analytics’ approach helps reimagine business processes
              and functions by aligning AI initiatives with measurable outcomes.
            </p>
          </div>
        </div>
      </main>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 border-t border-l border-slate-200">
          ...
          <div className="lg:col-span-2 border-r border-b border-slate-200 p-8 lg:p-12 flex flex-col justify-center">
            <div className="max-w-xl text-slate-700 leading-relaxed text-lg">
              <p>
                In today’s digital business landscape, organizations are awash with
                vast amount of data. By creating a well-defined AI strategy, carefully
                leveraging breakthrough innovations like Generative AI, and
                integrating insights into business functions, organizations can unlock
                opportunities at scale.
              </p>
              <p className="mt-4">
                Tigor Analytics brings the right expertise and capabilities to shape your
                AI and analytics roadmap closely aligned with your overall digital
...
<section className="px-6 md:px-16 lg:px-24 xl:px-20 py-20 bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {cardData.map((card, index) => (
            <div key={index} className="bg-[#2d2a28] text-white p-5 flex flex-col min-h-[180px] rounded-sm">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
      ...
      <div>
        <p className="text-slate-700 leading-relaxed max-w-xl">
          Our unique methodology spans three weeks. In the first two weeks, we
          gain a deeper understanding of our client’s landscape, from the
          process to data, technology, and organization. In the third week,
          we conduct a design workshop where a consensus roadmap is structured
          and implemented.
        </p>
      </div>
      ...
      <div>
        <p className="text-slate-700 leading-relaxed max-w-xl">
          The workshop helps the team build an understanding and consensus on
          moving forward, creating a concrete call to action that paves the
          way for success.
        </p>
      </div>
...
<section className="bg-white pb-24">
  <div className="mx-auto w-full max-w-[1600px] px-6 md:px-16 lg:px-24">
    <img
      src={Strategy}
      alt="Analytics roadmap infographic"
      className="
        w-full 
        h-auto 
        object-contain 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {[
            ...
            <div key={i}>
              ...
              <div className={`h-[2px] mb-6 ${i === 1 ? "bg-[#ff8a00]" : "bg-slate-300"}`} />
